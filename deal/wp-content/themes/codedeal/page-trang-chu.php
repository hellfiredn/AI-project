...
<?php $home_banners = codedeal_home_banners(); ?>
<section class="cd-brand-showcase" aria-label="Banner Tạp Hóa Giảm Giá">
    <div class="container">
        <div class="cd-banner-slider swiper" data-cd-banner-slider>
            <div class="swiper-wrapper">
                <?php foreach ($home_banners as $banner): ?>
                    <div class="swiper-slide">
                        <?php if (!empty($banner['link_url'])): ?>
                            <a class="cd-banner-slider__link" href="<?php echo esc_url($banner['link_url']); ?>" <?php echo $banner['target'] === '_blank' ? 'target="_blank" rel="noopener sponsored"' : ''; ?>>
                        <?php endif; ?>
                            <img src="<?php echo esc_url($banner['image_url']); ?>" alt="<?php echo esc_attr($banner['image_alt']); ?>">
                        <?php if (!empty($banner['link_url'])): ?>
                            </a>
                        <?php endif; ?>
                    </div>
            ...
            <?php if (count($home_banners) > 1): ?>
                <div class="cd-banner-slider__pagination swiper-pagination"></div>
                <button class="cd-banner-slider__nav cd-banner-slider__nav--prev swiper-button-prev" type="button" aria-label="<?php esc_attr_e('Banner trước', 'codedeal'); ?>"></button>
                <button class="cd-banner-slider__nav cd-banner-slider__nav--next swiper-button-next" type="button" aria-label="<?php esc_attr_e('Banner tiếp theo', 'codedeal'); ?>"></button>
            <?php endif; ?>
        </div>
    </div>
</section>
